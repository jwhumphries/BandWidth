...
/**
 * The folder rail shared by the personal library and the band view.
 *
 * Presentation only — the personal and band sidebars bind their own hooks and
 * pass the results in, so both libraries stay identical by construction
 * rather than by two copies being kept in step by hand.
 */
export default function FolderSidebarView({
  folders,
  canEdit,
  selectedId,
  creating = false,
